...
export default class AtomWindowsTitlebarMenu {
   ...
   buildTheMenuHTML(){
      ...
      document.querySelector('.atom-windows-titlebar-title-container').insertBefore(this.container, document.querySelector('.atom-windows-titlebar-title-container').children[1])
      this.buildMenus()
   }
